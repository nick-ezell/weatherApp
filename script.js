$(document).ready(function () {
    ...
    searchBtn.on("click", function () {
        ...
        let queryURL = "https://cors-anywhere.herokuapp.com/https://api.openweathermap.org/data/2.5/weather?q=" + city + "&APPID=" + key;
        ...
        $.ajax({
            ...
            // let weatherIcon = $("<img>").attr("src", "https://cors-anywhere.herokuapp.com/https://openweathermap.org/img/wn/" + icon + ".png");
            let fiveDayURL = "https://cors-anywhere.herokuapp.com/https://api.openweathermap.org/data/2.5/forecast?appid=" + key + "&q=" + props.name + "," + props.sys.country;
            let uvQuery = "https://cors-anywhere.herokuapp.com/https://api.openweathermap.org/data/2.5/uvi?appid=" + key + "&lat=" + props.coord.lat + "&lon=" + props.coord.lon;
